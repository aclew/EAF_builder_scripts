...
# This script is mostly just me trying to figure out how to make eaf files out of the data in a csv for a set of ACLEW recordings.
# The real script that does this job will be uploaded to GitHub once I've done my investiagion in to how to do this :D
...
for file_path in glob.glob('{}/*.eaf'.format(sys.argv[1])):
    ...
    code_blocks = eafob.get_annotation_data_for_tier('code_num')
    ...
    # new_eaf.add_annotation("FA1", start_time, start_time + 60000)
